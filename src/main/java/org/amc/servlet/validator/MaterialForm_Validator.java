...
public class MaterialForm_Validator extends WebPageFormValidator {
    public List<String> validate(MaterialForm form) {
        ...
        /*
         * private float density; private float linear_expansion; private float
         * water_absorption; private float material_drying; private float
         * melting_temp_lower; private float melting_temp_upper; private float
         * mould_shrinkage; private float mould_temp_low; private float
         * mould_temp_upper;
         */
        String[][] arguments = { { "density", form.getDensity() },
