...
/**
 * Servlet Filter implementation class UserFilter Adds a User object which
 * represents the currently logged in user to the Session If the User is
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        synchronized (httpRequest.getSession()) {
            ...
            if (httpRequest.getUserPrincipal() != null
                            && httpRequest.getSession().getAttribute(SESSIONVAR_USER) == null) {
                if (httpRequest.getSession().getAttribute(SESSIONVAR_REMOTE_ADDRESS) == null) {
                    httpRequest.getSession().setAttribute(SESSIONVAR_REMOTE_ADDRESS,
                ...
                if (user.isActive()) {
                    ...
                    throw new ServletException("User " + user.getUserName()
                                    + " has been deactivated. Contact the System adminstrator");
                }
        ...
        try {
            ...
            if (listOfUser != null && listOfUser.size() == 1) {
                ...
                throw new ServletException(
                                "No User has been found in the User Database with that User name");
            }
