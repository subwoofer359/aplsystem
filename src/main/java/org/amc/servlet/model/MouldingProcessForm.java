...
public class MouldingProcessForm {
     ...
     */
    public static MouldingProcess getMouldingProcess(MouldingProcessForm jForm)
        ...
        try {
            ...
            processSheet.setMouldClosingOpenLimitPos(Float.parseFloat(jForm
                            .getMouldClosingOpenLimitPos()));
            processSheet.setMouldClosingOpenLimitSpeed(Float.parseFloat(jForm
                            .getMouldClosingOpenLimitSpeed()));
            ...
            processSheet.setMouldOpenBreakAwaySpeed(Float.parseFloat(jForm
                            .getMouldOpenBreakAwaySpeed()));
