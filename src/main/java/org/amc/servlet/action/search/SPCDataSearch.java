...
public class SPCDataSearch extends WebFormSearch
{
	...
	/**
	 * @param spcMeasurement the spcMeasurement to set
	 */
	...
	/**
	 * @param lowerBoundMeasuremenet the lowerBoundMeasuremenet to set
	 */
	...
	/**
	 * @param upperBoundMeasurement the upperBoundMeasurement to set
	 */
