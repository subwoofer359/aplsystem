...
public class APLUserController {
     ...
     * @param model
     * @param user
     *            User created by Spring from the request parameters
     * @param mode
     *            The mode the page was in: Edit or add
     * @param roles
     *            The roles select on the JSP
     * @return
     */
    @RequestMapping("/User_Save")
    public String saveUser(Model model, @Valid @ModelAttribute(USER) User user,
                    BindingResult result, @RequestParam(MODE) String mode,
        ...
        try {
            ...
            // If the user's password doesn't equals the DEFAULT password then
            ...
            for (int i = 0; i < tempRoles.length; i++) {
                ...
                if (!exists) {
                    // If the role doesn't exist then create a new role for the
                    // user and add to new list
            ...
            // Check validation if fails return to page to get correct
            // information
    ...
    public void isUserNameAvailable(@RequestParam final String username,
     ...
     * 
     * @param mode
     *            The mode the page is in: Edit or add
     * @param id
     *            The database id of the User from page
     * @param model
     * @return ModelAndView containing the user to edit and setting view to
     *         User.jsp
     */
    @RequestMapping("/Users_edit")
    public ModelAndView editUsers(@RequestParam(MODE) String mode,
