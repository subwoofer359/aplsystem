...
public class MouldingProcess implements Serializable, WorkEntity {
    ...
    static {
        ...
        listOfFields.add("id");
        listOfFields.add("partId");
        listOfFields.add("machineSize");
        listOfFields.add("machineNo");
        listOfFields.add("material");
        listOfFields.add("masterbatchNo");
        listOfFields.add("dateOfIssue");
        listOfFields.add("signOffBy");
        listOfFields.add("processNotes");
        listOfFields.add("injectionSpeed_1");
        listOfFields.add("injectionSpeed_2");
        listOfFields.add("injectionSpeed_3");
        listOfFields.add("injectionSpeed_4");
        listOfFields.add("injectionSpeed_5");
        listOfFields.add("injectionSpeed_6");
        listOfFields.add("injSpeedPosition_1");
        listOfFields.add("injSpeedPosition_2");
        listOfFields.add("injSpeedPosition_3");
        listOfFields.add("injSpeedPosition_4");
        listOfFields.add("injSpeedPosition_5");
        listOfFields.add("injSpeedPosition_6");
        listOfFields.add("holdingPressure_1");
        listOfFields.add("holdingPressure_2");
        listOfFields.add("holdingPressure_3");
        listOfFields.add("holdingPressure_4");
        listOfFields.add("holdingPressure_5");
        listOfFields.add("holdingPressure_6");
        listOfFields.add("holdingTime_1");
        listOfFields.add("holdingTime_2");
        listOfFields.add("holdingTime_3");
        listOfFields.add("holdingTime_4");
        listOfFields.add("holdingTime_5");
        listOfFields.add("holdingTime_6");
        listOfFields.add("maxPackVel");
        listOfFields.add("posTran");
        listOfFields.add("maxInjPre");
        listOfFields.add("maxInjTime");
        listOfFields.add("shotSize");
        listOfFields.add("decompressionDist");
        listOfFields.add("decompressionVel");
        listOfFields.add("coolTime");
        listOfFields.add("backPressure_1");
        listOfFields.add("backPressure_2");
        listOfFields.add("backPressure_3");
        listOfFields.add("backPressure_4");
        listOfFields.add("backPressure_5");
        listOfFields.add("backPressure_6");
        listOfFields.add("screwExtSpeed_1");
        listOfFields.add("screwExtSpeed_2");
        listOfFields.add("screwExtSpeed_3");
        listOfFields.add("screwExtSpeed_4");
        listOfFields.add("screwExtSpeed_5");
        listOfFields.add("screwExtSpeed_6");
        listOfFields.add("extProfilePos_1");
        listOfFields.add("extProfilePos_2");
        listOfFields.add("extProfilePos_3");
        listOfFields.add("extProfilePos_4");
        listOfFields.add("extProfilePos_5");
        listOfFields.add("extProfilePos_6");
        listOfFields.add("nozzelTemperature");
        listOfFields.add("barrelTemperature_1");
        listOfFields.add("barrelTemperature_2");
        listOfFields.add("barrelTemperature_3");
        listOfFields.add("barrelTemperature_4");
        listOfFields.add("throatTemperature");
        listOfFields.add("mouldClosingOpenLimitPos");
        listOfFields.add("mouldClosingOpenLimitSpeed");
        listOfFields.add("mouldClosedLimitPos");
        listOfFields.add("mouldClosedLimitSpeed");
        listOfFields.add("clsSlowPos");
        listOfFields.add("clsSlowSpeed");
        listOfFields.add("clsSPPos");
        listOfFields.add("clsSPSpeed");
        listOfFields.add("mouldOpenBreakAwaySpeed");
        listOfFields.add("mouldOpenStepPos_1");
        listOfFields.add("mouldOpenStepSpeed_1");
        listOfFields.add("mouldOpenStepPos_2");
        listOfFields.add("mouldOpenStepSpeed_2");
        listOfFields.add("mouldOpenStepPos_3");
        listOfFields.add("mouldOpenStepSpeed_3");
        listOfFields.add("mouldOpenTime");
        listOfFields.add("ejectStart");
        listOfFields.add("ejectMode");
        listOfFields.add("ejectPulse");
        listOfFields.add("ejectDelay");
        listOfFields.add("ejectorsFwdPos");
        listOfFields.add("ejectorsFwdSpeed");
        listOfFields.add("ejectorsFwdTime");
        listOfFields.add("ejectorsStopPos");
        listOfFields.add("ejectorsStopSpeed");
        listOfFields.add("ejectorsStopTime");
        listOfFields.add("ejectorsRevPos");
        listOfFields.add("ejectorsRevSpeed");
        listOfFields.add("ejectorsRevTime");
        listOfFields.add("dme_1");
        listOfFields.add("dme_2");
        listOfFields.add("dme_3");
        listOfFields.add("dme_4");
        listOfFields.add("dme_5");
        listOfFields.add("dme_6");
        listOfFields.add("dme_7");
        listOfFields.add("dme_8");
        listOfFields.add("waterTempFixedHalf");
        listOfFields.add("waterTempMovingHalf");
        listOfFields.add("waterTempNotes");
        FIELDS = Collections.unmodifiableList(listOfFields);
    }
    /**
     * Serializable
     */
