...
public class MouldingProcess implements Serializable,WorkEntity
{
	...
	static
	{
		FIELDS =Collections.unmodifiableList(new ArrayList<String>());
		FIELDS.add("id");
		FIELDS.add("partId");
		FIELDS.add("machineSize");
		FIELDS.add("machineNo");
		FIELDS.add("material");
		FIELDS.add("masterbatchNo");
		FIELDS.add("dateOfIssue");
		FIELDS.add("signOffBy");
		FIELDS.add("processNotes");
		FIELDS.add("injectionSpeed_1");
		FIELDS.add("injectionSpeed_2");
		FIELDS.add("injectionSpeed_3");
		FIELDS.add("injectionSpeed_4");
		FIELDS.add("injectionSpeed_5");
		FIELDS.add("injectionSpeed_6");
		FIELDS.add("injSpeedPosition_1");
		FIELDS.add("injSpeedPosition_2");
		FIELDS.add("injSpeedPosition_3");
		FIELDS.add("injSpeedPosition_4");
		FIELDS.add("injSpeedPosition_5");
		FIELDS.add("injSpeedPosition_6");
		FIELDS.add("holdingPressure_1");
		FIELDS.add("holdingPressure_2");
		FIELDS.add("holdingPressure_3");
		FIELDS.add("holdingPressure_4");
		FIELDS.add("holdingPressure_5");
		FIELDS.add("holdingPressure_6");
		FIELDS.add("holdingTime_1");
		FIELDS.add("holdingTime_2");
		FIELDS.add("holdingTime_3");
		FIELDS.add("holdingTime_4");
		FIELDS.add("holdingTime_5");
		FIELDS.add("holdingTime_6");
		FIELDS.add("maxPackVel");
		FIELDS.add("posTran");
		FIELDS.add("maxInjPre");
		FIELDS.add("maxInjTime");
		FIELDS.add("shotSize");
		FIELDS.add("decompressionDist");
		FIELDS.add("decompressionVel");
		FIELDS.add("coolTime");
		FIELDS.add("backPressure_1");
		FIELDS.add("backPressure_2");
		FIELDS.add("backPressure_3");
		FIELDS.add("backPressure_4");
		FIELDS.add("backPressure_5");
		FIELDS.add("backPressure_6");
		FIELDS.add("screwExtSpeed_1");
		FIELDS.add("screwExtSpeed_2");
		FIELDS.add("screwExtSpeed_3");
		FIELDS.add("screwExtSpeed_4");
		FIELDS.add("screwExtSpeed_5");
		FIELDS.add("screwExtSpeed_6");
		FIELDS.add("extProfilePos_1");
		FIELDS.add("extProfilePos_2");
		FIELDS.add("extProfilePos_3");
		FIELDS.add("extProfilePos_4");
		FIELDS.add("extProfilePos_5");
		FIELDS.add("extProfilePos_6");
		FIELDS.add("nozzelTemperature");
		FIELDS.add("barrelTemperature_1");
		FIELDS.add("barrelTemperature_2");
		FIELDS.add("barrelTemperature_3");
		FIELDS.add("barrelTemperature_4");
		FIELDS.add("throatTemperature");
		FIELDS.add("mouldClosingOpenLimitPos");
		FIELDS.add("mouldClosingOpenLimitSpeed");
		FIELDS.add("mouldClosedLimitPos");
		FIELDS.add("mouldClosedLimitSpeed");
		FIELDS.add("clsSlowPos");
		FIELDS.add("clsSlowSpeed");
		FIELDS.add("clsSPPos");
		FIELDS.add("clsSPSpeed");
		FIELDS.add("mouldOpenBreakAwaySpeed");
		FIELDS.add("mouldOpenStepPos_1");
		FIELDS.add("mouldOpenStepSpeed_1");
		FIELDS.add("mouldOpenStepPos_2");
		FIELDS.add("mouldOpenStepSpeed_2");
		FIELDS.add("mouldOpenStepPos_3");
		FIELDS.add("mouldOpenStepSpeed_3");
		FIELDS.add("mouldOpenTime");
		FIELDS.add("ejectStart");
		FIELDS.add("ejectMode");
		FIELDS.add("ejectPulse");
		FIELDS.add("ejectDelay");
		FIELDS.add("ejectorsFwdPos");
		FIELDS.add("ejectorsFwdSpeed");
		FIELDS.add("ejectorsFwdTime");
		FIELDS.add("ejectorsStopPos");
		FIELDS.add("ejectorsStopSpeed");
		FIELDS.add("ejectorsStopTime");
		FIELDS.add("ejectorsRevPos");
		FIELDS.add("ejectorsRevSpeed");
		FIELDS.add("ejectorsRevTime");
		FIELDS.add("dme_1");
		FIELDS.add("dme_2");
		FIELDS.add("dme_3");
		FIELDS.add("dme_4");
		...
		FIELDS.add("dme_7");
		FIELDS.add("dme_8");
		FIELDS.add("waterTempFixedHalf");
		FIELDS.add("waterTempMovingHalf");
		FIELDS.add("waterTempNotes");
	}
	/**
	 * Serializable
	 */
