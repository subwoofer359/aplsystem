...
public class TestPartUI {
    ...
    public static void setUpTestFixture() {
        System.setProperty("webdriver.chrome.driver",
                        "/home/adrian/Programming/Chromedriver/chromedriver");
    }
    ...
    public void testLogin() {
        ...
        // Test logging 5 fives to see if there any issues with Database
        // connections
        for (int i = 0; i < 15; i++) {
            login();
    ...
    public void addPart() {
        ...
        String[] names = { "name", "company", "part_id", "version", "revision", "colour",
                "external", "qss_no" };
